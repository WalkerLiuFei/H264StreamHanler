...
#define PARSER_FLAG_USE_CODEC_TS              0x1000
    ...
    /**
     * The format of the coded data, corresponds to types AVPixelFormat for video
     * and for types AVSampleFormat for audio.
     *
...
types AVPixelFormat avcodec_find_best_pix_fmt2(const types AVPixelFormat *pix_fmt_list,
                                              types AVPixelFormat src_pix_fmt,
                                              int has_alpha, int *loss_ptr);
#else
